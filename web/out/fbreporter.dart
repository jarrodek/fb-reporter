...
void init_autogenerated() {
  ...
  __t.conditional(__e32, () => fbi.isFacebookConnected, (__t) {
    ...
    __t.conditional(__e13, () => fbi.selectedPage != null && fbi.pagePostList.length == 0 && !fbi.loading, (__t) {
      ...
      __e11 = __e12.nodes[1].nodes[3].nodes[1];
      __t.listen(__e11.onChange, ($event) { fbi.onDateRangeChange($event); });
      __t.oneWayBind(() => today, (e) { if (__e11.xtag.limitright != e) __e11.xtag.limitright = e; }, false, false);
      __t.oneWayBind(() => fbi.dateRangeEnd, (e) { if (__e11.xtag.selectionend != e) __e11.xtag.selectionend = e; }, false, false);
      __t.oneWayBind(() => fbi.dateRangeStart, (e) { if (__e11.xtag.selectionstart != e) __e11.xtag.selectionstart = e; }, false, false);
      __t.component(new DateRange()..host = __e11);
      __t.bindClass(__e12, () => postsListClass, false);
    __t.addAll([new autogenerated.Text('\n            '),
        __e12,
        new autogenerated.Text('\n          ')]);
    });
