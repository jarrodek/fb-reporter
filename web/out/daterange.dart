  ...
  static final __html1 = new autogenerated.Element.html('<div id="dr_calendarsHolder">\n            <div class="dr_calendarWrapper">\n              \n              <div class="dr_prev_container">\n                <button class="dr_button prev"></button>\n              </div>\n              <template></template>\n              <div class="dr_next_container">\n                <button class="dr_button next"></button>\n              </div>\n              <div class="dr_clearfix"></div>\n            </div>\n            <div class="dr_options-container">\n              <div class="dr_presets">\n                <span class="dr_label">Date range:</span>\n                <select id="DrPresetOption" class="dr_select">\n                  <option value="custom">Custom</option>\n                  <option value="today">Today</option>\n                  <option value="yesterday">Yesterday</option>\n                  <option value="last-week">Last week</option>\n                  <option value="last-month">Last month</option>\n                </select>\n              </div>\n              <div class="dr_range_inputs">\n                <input id="rangeInputStart" type="text">\n                <span class="dr_pause">-</span>\n                <input id="rangeInputEnd" type="text">\n              </div>\n              <div class="dr_options_actions">\n                <button class="dr_button apply">Apply</button>\n                <a href="about:blank" target="_blank" class="dr_cancel">Cancel</a>\n              </div>\n            </div>\n          </div>'), __html2 = new autogenerated.Element.html('<div class="dr_calendar-container">\n                   <div class="dr_month-row">\n                    <span class="dr_month-txt"></span>\n                    <span class="dr_year-txt"></span>\n                  </div>\n                  <div class="dr_calendar-body">\n                    <table class="dr_table">\n                      <thead>\n                        <tr></tr>\n                      </thead>\n                      <tbody></tbody>\n                    </table>\n                  </div>\n                 </div>'), __html3 = new autogenerated.Element.html('<th class="dr_weekday"></th>'), __html4 = new autogenerated.TableRowElement(), __html5 = new autogenerated.Element.html('<td class="dr_day">\n                            <template></template>\n                          </td>'), __html6 = new autogenerated.Element.tag('template'), __html7 = new autogenerated.Element.html('<div class="dr_selectable"></div>'), __html8 = new autogenerated.Element.tag('template'), __html9 = new autogenerated.Element.html('<div class="dr_selectable_void"></div>'), __shadowTemplate = new autogenerated.DocumentFragment.html('''
        <div class="dr_input-value-wrapper">
          ...
          <div class="dr_wrapper">
            <span class="dr_value-display"></span><span class="dr_down-handler"></span>
          </div>
          
          <template></template>
        </div>
      ''');
  autogenerated.DivElement __e120;
  autogenerated.Element __e149;
  autogenerated.SpanElement __e119;
  autogenerated.Template __t;

  void created_autogenerated() {
    var __root = createShadowRoot("x-date-range");
    setScopedCss("x-date-range", new autogenerated.ScopedCssMapper({".next":"next",".dr_clearfix":"dr_clearfix",".dr_pause":"dr_pause",".dr_input-value-wrapper":"dr_input-value-wrapper",".dr_select":"dr_select",".dr_day":"dr_day",".dr_button":"dr_button",".dr_selectable_void":"dr_selectable_void",".dr_selectable":"dr_selectable",".dr_down-handler":"dr_down-handler",".dr_weekday":"dr_weekday",".dr_prev_container":"dr_prev_container",".dr_options_actions":"dr_options_actions",".dr_hidden":"dr_hidden",".dr_wrapper":"dr_wrapper",".dr_table":"dr_table",".dr_value-display":"dr_value-display",".disabled":"disabled",".dr_calendarWrapper":"dr_calendarWrapper",".dr_label":"dr_label",".apply":"apply",".dr_options-container":"dr_options-container",".prev":"prev",".dr_range_inputs":"dr_range_inputs",".dr_next_container":"dr_next_container",".dr_calendar-container":"dr_calendar-container",".dr_selected":"dr_selected",".dr_month-row":"dr_month-row","#dr_calendarsHolder":"dr_calendarsHolder","x-date-range":"[is=\"x-date-range\"]"}));
    _css = getScopedCss("x-date-range");
    __t = new autogenerated.Template(__root);
    if (__root is autogenerated.ShadowRoot) __root.applyAuthorStyles = true;
    __root.nodes.add(__shadowTemplate.clone(true));
    __e120 = __root.nodes[1].nodes[1];
    __e119 = __e120.nodes[1];
    var __binding118 = __t.contentBind(() => displayValue, false);
    __e119.nodes.add(__binding118);
    __t.listen(__e120.onClick, ($event) { show($event); });
    __e149 = __root.nodes[1].nodes[3];
    __t.conditional(__e149, () => showing, (__t) {
      var __e121, __e140, __e141, __e142, __e143, __e144, __e145, __e146, __e147, __e148;
      __e148 = __html1.clone(true);
      __e121 = __e148.nodes[1].nodes[1].nodes[1];
      __t.listen(__e121.onClick, ($event) { previousMonth(); });
      __e140 = __e148.nodes[1].nodes[3];
      __t.loop(__e140, () => calendarsList, ($list, $index, __t) {
        var calendar = $list[$index];
        var __e123, __e125, __e128, __e138, __e139;
        __e139 = __html2.clone(true);
        __e123 = __e139.nodes[1].nodes[1];
        var __binding122 = __t.contentBind(() => calendar.monthName, false);
        __e123.nodes.add(__binding122);
        __e125 = __e139.nodes[1].nodes[3];
        var __binding124 = __t.contentBind(() => calendar.year, false);
        __e125.nodes.add(__binding124);
        __e128 = __e139.nodes[3].nodes[1].nodes[1].nodes[1];
        __t.loopIterateAttr(__e128, () => weekdayTexts, ($list, $index, __t) {
          var weekday = $list[$index];
          var __e127;
          __e127 = __html3.clone(true);
          var __binding126 = __t.contentBind(() => weekday, false);
          __e127.nodes.add(__binding126);
        __t.addAll([new autogenerated.Text('\n                          '),
            __e127,
            new autogenerated.Text('\n                        ')]);
        });
        __e138 = __e139.nodes[3].nodes[1].nodes[3];
        __t.loopIterateAttr(__e138, () => calendar.dates, ($list, $index, __t) {
          var weekList = $list[$index];
          var __e137;
          __e137 = __html4.clone(true);
          __t.loopIterateAttr(__e137, () => weekList, ($list, $index, __t) {
            var day = $list[$index];
            var __e135, __e136;
            __e136 = __html5.clone(true);
            __e135 = __e136.nodes[1];
            __t.conditional(__e135, () => day != null, (__t) {
              var __e131, __e134;
              __e131 = __html6.clone(true);
              __t.conditional(__e131, () => calendar.isSelectable(day), (__t) {
                var __e130;
                __e130 = __html7.clone(true);
                var __binding129 = __t.contentBind(() => day, false);
                __e130.nodes.add(__binding129);
                __t.listen(__e130.onClick, ($event) { selectDay(calendar.year,calendar.month,day); });
                __t.bindClass(__e130, () => isSelected(calendar.year,calendar.month,day) ? ' dr_selected' : '', false);
              __t.addAll([new autogenerated.Text('\n                                '),
                  __e130,
                  new autogenerated.Text('\n                              ')]);
              });

              __e134 = __html8.clone(true);
              __t.conditional(__e134, () => !calendar.isSelectable(day), (__t) {
                var __e133;
                __e133 = __html9.clone(true);
                var __binding132 = __t.contentBind(() => day, false);
                __e133.nodes.add(__binding132);
              __t.addAll([new autogenerated.Text('\n                                '),
                  __e133,
                  new autogenerated.Text('\n                              ')]);
              });
      ...
      __e141 = __e148.nodes[1].nodes[5].nodes[1];
      __t.listen(__e141.onClick, ($event) { nextMonth(); });
      __e142 = __e148.nodes[3].nodes[1].nodes[3];
      __t.listen(__e142.onChange, ($event) { presetRange($event); });
      __e145 = __e148.nodes[3].nodes[3];
      __e143 = __e145.nodes[1];
      __t.listen(__e143.onChange, ($event) { rangeInputsChange($event); });
      __t.listen(__e143.onFocus, ($event) { setAsCustomSelection(); });
      __t.listen(__e143.onInput, ($event) { startDateInput = __e143.value; });
      __t.oneWayBind(() => startDateInput, (e) { if (__e143.value != e) __e143.value = e; }, false, false);
      __e144 = __e145.nodes[5];
      __t.listen(__e144.onChange, ($event) { rangeInputsChange($event); });
      __t.listen(__e144.onFocus, ($event) { setAsCustomSelection(); });
      __t.listen(__e144.onInput, ($event) { endDateInput = __e144.value; });
      __t.oneWayBind(() => endDateInput, (e) { if (__e144.value != e) __e144.value = e; }, false, false);
      __t.bindClass(__e145, () => inputRangeCss, false);
      __e146 = __e148.nodes[3].nodes[5].nodes[1];
      __t.listen(__e146.onClick, ($event) { apply($event); });
      __e147 = __e148.nodes[3].nodes[5].nodes[3];
      __t.listen(__e147.onClick, ($event) { cancel($event); });
    __t.addAll([new autogenerated.Text('\n          \n          '),
        __e148,
        new autogenerated.Text('\n          ')]);
    });
