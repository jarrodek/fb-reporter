...
FacebookInsights: {"": "Object;auth,google_auth_token,fbauth,pagesListLoading?,pagePostListLoading,spreadsheetUpdating,pagePostInsightLoading,pagesList<,pagePostList,nextPagePostToken,selectedPage,selectedPost,facebookPagesConfig?,spreadsheetSheetsList,spreadsheetSheetsListLoading,postsSelectionController,pagePostInsights,_alowedExtenralAction",
...
FacebookInsights$: function() {
  var t1 = new $.FacebookInsights(null, null, null, false, false, false, false, $.toObservable([]), $.toObservable([]), null, null, null, $.HashMap$(null, null), $.toObservable($.Map_Map(null, null)), false, $.PostsSelectionController$(), null, ["select-spreadsheet-for-page", "create-spreadsheet-for-page", "detach-spreadsheet-from-page", "add-worksheet-to-page", "replace-worksheet-for-page"]);
